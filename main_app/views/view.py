...
def indexPanelView(request):
    ...
    return render(request, 'dashboard/dashboard.html', {"title":"پنل کاربری", "order_count":order_count, "process_count":process_count, "active_process":active_process,"orders":orders, })
